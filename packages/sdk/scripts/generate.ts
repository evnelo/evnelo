 ...
 * src/schema.d.ts for openapi-fetch. Run: pnpm --filter @ot/sdk generate
 */
...
const header = "// Generated from apps/web/lib/openapi.ts by `pnpm --filter @ot/sdk generate`. Do not edit by hand.\n\n";
